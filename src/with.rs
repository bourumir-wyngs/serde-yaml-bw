...
/// #[derive(Serialize, Deserialize, PartialEq, Debug)]
/// struct Struct {
///     #[serde(with = "serde_yaml_bw::with::singleton_map")]
///     w: Enum,
///     #[serde(with = "serde_yaml_bw::with::singleton_map")]
///     x: Enum,
///     #[serde(with = "serde_yaml_bw::with::singleton_map")]
...
///     };
///
///     let yaml = serde_yaml_bw::to_string(&object).unwrap();
///     print!("{}", yaml);
///
...
///     tagged_style: Inner,
///
///     #[serde(with = "serde_yaml_bw::with::singleton_map_recursive")]
...
///     print!("{}", yaml);
///
///     let deserialized: Outer = serde_yaml_bw::from_str(&yaml).unwrap();
///     assert_eq!(object, deserialized);
/// }
/// ```
///
